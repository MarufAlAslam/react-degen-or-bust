...
const TopBar = ({ setVisiblePastWinners, visiblePastWinners, setVisibleFaq, setVisibleHowToPlay,setVisibleResponsibility }) => {
            ...
            <div className='custom-container'>
                <div className='flex justify-between items-center'>
                    ...
                    <div className='md:hidden block absolute'>
                        <div onClick={handleMobileMenu} className='menu-overlay translate-x-[-100%] h-screen w-full fixed top-0 left-0 z-20 bg-[#00000080]'></div>
                            ...
                            <div className='w-full'>
                                <div className='flex mb-[65px] justify-between items-center w-full'>
                                    <button className='text-white text-xl'>
                                        {
                                            muted ? <HiSpeakerXMark onClick={() => setMuted(!muted)} /> : <HiSpeakerWave onClick={() => setMuted(!muted)} />
                                        }
                                    </button>
                                    <button onClick={handleMobileMenu} className='text-white text-xl'>
                                        <IoClose />
                                    </button>
                                </div>

                                <div className='text-center w-full'>
                                    <button className='btn-blue flex justify-center items-center rounded-full mb-[16px] mx-auto'>Connect Wallet
                                    </button>
